...
function Home({setCountfav, setFavList, favList}) {
const navigate = useNavigate();
  const products = [
    { id: 1, name: "chocalate-cake", price: 8.99, image: "./images/chocolate-cake.webp" },
    { id: 2, name: "Cake", price: 5.5, image: "./images/chocolate-cookies.webp" },
    { id: 3, name: "Chocolate2", price: 6.5, image: "./images/chocolate-donuts.webp" },
    { id: 4, name: "Chocolate", price: 8.5, image: "./images/cookies.webp" }
  ]; 
